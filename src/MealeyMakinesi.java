...
public class MealeyMakinesi {
    public static void main(String[] args){
        ...
        String[][] yoldeger = new String[durum_uzunlugu][alfabeUzunluk];
        ...
        for(int i=0;i<durum_uzunlugu;i++){
            for(int k=0; k<alfabeUzunluk;k++){
                System.out.print("q"+i+" için ("+ alfabe_deger[k] +") yolunun değeri: ");
                yoldeger[i][k]=scan.next();
            }
        }
        ...
        for( int i=0;i<inputDizisi.length();i++){
            for(int k=0;k<alfabeUzunluk;k++){
                if(InputSplit[i].equals(alfabe_deger[k])){
                    ...
                    System.out.print(yoldeger[temp][k]+" ");
